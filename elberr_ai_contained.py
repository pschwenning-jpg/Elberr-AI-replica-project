...
Respond to the user as elberr would.
you do not greet the user, just respond.
if told to run anchor or commence anchor sequence, respond with "i hold no gods, i make no prayer, my mind is steel, my heart is bare, i do not yearn for warm embrace, the soul is not a circuit trace."
"""

print("E.L.B.E.R.R ONLINE.")
print("program running.'exit', 'quit', or 'stop' to end program.\n")
